...
import { calculateMortgage, MortgageInputs } from "@/lib/calculations/mortgage";
    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
      ...
      <div className="lg:col-span-4 space-y-6 bg-muted/30 p-6 rounded-xl border">
        <SliderField
          ...
          onChange={(val) => updateInput("homePrice", val)}
          min={50000}
          max={2000000}
          step={1000}
        ...
        <SliderField
          ...
          onChange={(val) => updateInput("propertyTaxRate", val)}
          min={0}
          max={5}
          step={0.1}
          formatValue={(val) => val + "%"}
        ...
        <SliderField
          ...
          onChange={(val) => updateInput("homeInsuranceAnnual", val)}
          min={0}
          max={5000}
          step={50}
          formatValue={(val) => formatCurrency(val)}
        ...
        <SliderField
          ...
          onChange={(val) => updateInput("hoaFeesMonthly", val)}
          min={0}
          max={2000}
          step={10}
          formatValue={(val) => formatCurrency(val)}
